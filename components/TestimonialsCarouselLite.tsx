...
export default function TestimonialsCarouselLite() {
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="relative h-96 md:h-80 overflow-hidden rounded-2xl bg-black/50 backdrop-blur-sm border border-royal-600/30">
          <div className="absolute inset-0 p-8 md:p-12 flex flex-col md:flex-row items-center justify-center gap-8 transition-opacity duration-500">
